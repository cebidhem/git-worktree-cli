...
from ez_leaf.cli import app
from ez_leaf.worktree import WorktreeError
from ez_leaf.launchers import LauncherError
...
class TestCLIVersion:
    ...
    def test_version_option(self):
        ...
        assert "ez-leaf version" in result.stdout
...
class TestCLICreate:
    ...
    def test_create_worktree_default_mode(self, mocker):
        ...
        mock_create = mocker.patch(
            "ez_leaf.cli.create_worktree",
            return_value=Path("/path/to/worktree")
        )
        mock_handle_mode = mocker.patch("ez_leaf.cli.handle_mode")
...
class TestCLIList:
    ...
    def test_list_worktrees_empty(self, mocker):
        ...
        mocker.patch("ez_leaf.cli.list_worktrees", return_value=[])
...
class TestCLIDelete:
    ...
    def test_delete_worktree(self, mocker):
        ...
        mock_delete = mocker.patch("ez_leaf.cli.delete_worktree")
...
class TestCLIHelp:
    ...
    def test_main_help(self):
        ...
        assert result.exit_code == 0
        assert "ez-leaf" in result.stdout
